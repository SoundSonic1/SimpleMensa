...
package com.soundsonic.simplemensa.data.cardcheck;
...
import com.soundsonic.simplemensa.data.cardcheck.card.desfire.DesfireFileSettings;
...
public class Utils {
    ...
    */
	...
	private static boolean arrayContains(int[] arr, int item) {
		for (int i: arr)
			if (i==item)
				return true;
		return false;
